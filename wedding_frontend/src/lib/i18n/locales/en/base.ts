export const baseEn = {
  ...
  services: {
    ...
    editTitle: "Edit Service",
    createDescription:
      "Create a catalog service or an operational line item that can be used in events.",
    editDescription: "Update service details, pricing, and status.",
    backToServices: "Back to Services",
    listTitle: "Services List",
    basicInformation: "Basic Information",
    basicInformationHint:
      "Capture the service identity, category, and pricing model.",
    name: "Service Name",
    ...
    pricingSection: "Pricing Details",
    pricingSectionHint:
      "Store the base commercial values used when this service is added to an event.",
    basePrice: "Base Price",
    ...
    description: "Description",
    descriptionPlaceholder:
      "Add scope details, included items, or internal planning notes...",
    noDescription: "No description added yet.",
    statusLabel: "Status",
    statusFilter: "Status Filter",
    allStatuses: "All Services",
  ...
  events: {
    ...
    linkedRecordsHint:
      "Link the event to a customer when available, or create it from an attended source appointment.",
    ...
    activeQueueHint:
      "Designing, quotation, confirmation, and execution stages.",
  ...
  quotations: {
    ...
    timelineContractCreatedHint:
      "Downstream contract {{contract}} now carries the commitment workflow.",
    ...
    confirmWorkflowActionHint:
      "This quotation will move to the selected workflow stage.",
    ...
    approveQuotationActionHint:
      "Make this quotation the approved commercial basis.",
  ...
  contracts: {
    ...
    timelineCreatedHint:
      "The commitment record was created from the commercial workflow.",
    timelineSignedDate: "Contract signed date recorded",
    timelineSignedDateHint:
      "This is the main commitment date currently stored on the contract.",
    ...
    confirmWorkflowActionHint:
      "This contract will move to the selected workflow stage.",
    eventReference: "Event #{{id}}",
    ...
    activateContractActionHint:
      "Move this signed contract into the active commitment stage.",
    ...
    terminateContractConfirmMessage:
      "This contract will be marked as terminated.",
    status: {
      draft: "Draft",
      issued: "Issued",
      signed: "Signed",
  ...
  appointments: {
    ...
    calendarPage: {
      ...
      filtersDescription:
        "Quick appointment filters for search, status, customer, and date preset.",
    ...
    workflowBlockedMessage:
      "This appointment is no longer active in the workflow.",
    ...
    workflowDashboardHint:
      "Track intake load, attended appointments ready for conversion, and blocked appointments before they disappear into the table.",
    workflowDashboardEyebrow: "Workflow Dashboard",
