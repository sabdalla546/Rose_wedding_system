  ...
  en: {
    translation: {
      ...
      execution: {
        ...
        workspaceDescription:
          "Prepare the final execution board for the wedding after the contract is issued.",
        noContractTitle: "No contract found for this event",
        noContractDescription:
          "Create a contract first, then return here to prepare the execution brief and service blocks.",
        ...
        createBriefDescription:
          "Generate the first execution brief from the confirmed event services.",
        ...
        serviceDetailsEditorHint:
          "Review each service as a visual execution card, then open the block that needs editing.",
        serviceBoardHint:
          "Open one card at a time to keep the board compact and visually clear.",
        noServiceDetailsTitle: "No execution service details yet",
        noServiceDetailsDescription:
          "The brief exists, but no service execution blocks are available yet.",
        ...
        noServiceAttachments:
          "No attachments uploaded for this service yet.",
        ...
        toast: {
          ...
          serviceDetailUpdated:
            "Execution service detail updated successfully",
          serviceDetailUpdateFailed:
            "Failed to update execution service detail",
  ...
  ar: {
    translation: {
      ...
      execution: {
        ...
        serviceDetailsEditorHint:
          "راجع كل خدمة كبطاقة تنفيذ بصرية، ثم افتح البلوك الذي يحتاج إلى تعديل.",
        serviceBoardHint:
          "افتح بطاقة واحدة في كل مرة ليبقى العرض مرتباً وواضحاً بصرياً.",
        noServiceDetailsTitle: "لا توجد تفاصيل تنفيذ للخدمات بعد",
        noServiceDetailsDescription:
          "تم إنشاء البريف، لكن لا توجد بلوكات تنفيذ للخدمات حتى الآن.",
        templateKey: "القالب",
        status: "الحالة",
        sortOrder: "الترتيب",
        executorNotes: "ملاحظات المنفذ",
        notesPlaceholder:
          "ملاحظات المصمم، توجه الخدمة، نقاط المتابعة...",
        executorNotesPlaceholder:
          "ملاحظات تشغيلية للمنفذ وفريق التنسيق...",
