...
export const routeAccessByHref: Record<string, RouteAccess> = {
  ...
  "/settings/vendors/types": { permission: "vendors.read" },
  "/settings/vendors/types/create": { permission: "vendors.create" },
  "/settings/vendors/types/edit/:id": { permission: "vendors.update" },
