...
export type QuotationWorkflowStatus = (typeof QUOTATION_WORKFLOW_STATUSES)[number];
...
export const EXECUTION_BRIEF_LEGACY_STATUSES = [
  "handed_to_executor",
] as const;
...
export const PRE_FINAL_EXECUTION_STATUSES = new Set<ExecutionBriefWorkflowStatus>([
  "draft",
  "under_review",
  "approved",
  "handed_off",
